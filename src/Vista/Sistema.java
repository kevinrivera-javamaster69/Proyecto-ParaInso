...
public final class Sistema extends javax.swing.JFrame {
    ...
    AmbienteDao abDao = new AmbienteDao();
    ...
    UsuariosDao lgDao = new UsuariosDao();
    int item;
    ...
    public Sistema(Usuarios priv) {
        initComponents();
        ImageIcon img = new ImageIcon(getClass().getResource("/Iconos/buho.png"));
    ...
    private void initComponents() {
        ...
        jPanel9Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                .addGap(30, 30, 30)
                .addComponent(jScrollPane8, javax.swing.GroupLayout.PREFERRED_SIZE, 1004, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        btnRegistrarSala.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/GuardarTodo.png"))); // NOI18N
        ...
        btnActualizarSala.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/Actualizar (2).png"))); // NOI18N
        ...
        btnNuevoSala.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/nuevo.png"))); // NOI18N
        ...
        btnEliminarSala.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/eliminar.png"))); // NOI18N
        ...
        jTabbedPane1.addTab("Box", jPanel22);
        ...
        tableMenu.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "", "Elemento", "Cant", "Precio", "SubTotal", "Comentario"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/money.png"))); // NOI18N
        ...
        btnEliminarTempPlato.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/eliminar.png"))); // NOI18N
        ...
        jPanel24.getAccessibleContext().setAccessibleName("Carta");

        jTabbedPane1.addTab("Pedidos", jPanel23);
        ...
        jLabel17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/money.png"))); // NOI18N
        ...
        btnPdfPedido.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/pdf.png"))); // NOI18N
        ...
        TablePedidos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Elemento", "Atendido", "N° Mesa", "Fecha", "Total", "Estado"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        jPanel6.add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 1020, 480));
        ...
        jLabel21.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/portada.png"))); // NOI18N
        ...
        if (TableUsuarios.getColumnModel().getColumnCount() > 0) {
            ...
            TableUsuarios.getColumnModel().getColumn(2).setMaxWidth(200);
        }
        ...
        btnGuardarPlato.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/GuardarTodo.png"))); // NOI18N
        ...
        btnEditarPlato.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/Actualizar (2).png"))); // NOI18N
        ...
        btnEliminarPlato.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/eliminar.png"))); // NOI18N
        ...
        btnNuevoPlato.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/nuevo.png"))); // NOI18N
        ...
        TablePlatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "NOMBRE", "PRECIO", "STOCK", "TIPO", "PRESENTACIÓN"
            }
        ));
        ...
        if (TablePlatos.getColumnModel().getColumnCount() > 0) {
            ...
            TablePlatos.getColumnModel().getColumn(0).setPreferredWidth(50);
            TablePlatos.getColumnModel().getColumn(0).setMaxWidth(50);
            TablePlatos.getColumnModel().getColumn(2).setMinWidth(70);
            TablePlatos.getColumnModel().getColumn(2).setPreferredWidth(70);
            TablePlatos.getColumnModel().getColumn(2).setMaxWidth(70);
            TablePlatos.getColumnModel().getColumn(3).setMinWidth(70);
            TablePlatos.getColumnModel().getColumn(3).setPreferredWidth(70);
            TablePlatos.getColumnModel().getColumn(3).setMaxWidth(70);
        }
        ...
        jTabbedPane1.addTab("Carta", jPanel2);

        getContentPane().add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 190, 1060, 610));

        btnPlatos.setBackground(new java.awt.Color(102, 102, 102));
        btnPlatos.setForeground(new java.awt.Color(255, 255, 255));
        btnPlatos.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/ayuda.png"))); // NOI18N
        btnPlatos.setText("Carta");
        btnPlatos.setBorder(new javax.swing.border.MatteBorder(null));
        ...
        getContentPane().add(btnPlatos, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 80, 200, 45));

        btnSala.setBackground(new java.awt.Color(102, 102, 102));
        btnSala.setForeground(new java.awt.Color(255, 255, 255));
        btnSala.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/sala.png"))); // NOI18N
        btnSala.setText("Ambientes");
        btnSala.setBorder(new javax.swing.border.MatteBorder(null));
        ...
        getContentPane().add(btnSala, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 30, 200, 45));

        btnVentas.setBackground(new java.awt.Color(102, 102, 102));
        btnVentas.setForeground(new java.awt.Color(255, 255, 255));
        btnVentas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/pedidos.png"))); // NOI18N
        ...
        getContentPane().add(btnVentas, new org.netbeans.lib.awtextra.AbsoluteConstraints(1130, 80, 200, 45));

        btnConfig.setBackground(new java.awt.Color(102, 102, 102));
        btnConfig.setForeground(new java.awt.Color(255, 255, 255));
        btnConfig.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/config.png"))); // NOI18N
        ...
        getContentPane().add(btnConfig, new org.netbeans.lib.awtextra.AbsoluteConstraints(1130, 30, 200, 45));
        ...
        getContentPane().add(btnUsuarios, new org.netbeans.lib.awtextra.AbsoluteConstraints(1130, 130, 200, 45));
        ...
        jLabel38.setText("PARA INSO HOUSE MUSIC");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(85, 85, 85)
                .addComponent(labelLogo, javax.swing.GroupLayout.PREFERRED_SIZE, 234, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(34, 34, 34)
                .addComponent(tipo)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1340, 790));
    ...
    private void btnRegistrarSalaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarSalaActionPerformed
        ...
        if (txtNombreSala.getText().equals("") || txtMesas.getText().equals("")) {
            ...
            ab.setNombre(txtNombreSala.getText());
            ab.setBox(Integer.parseInt(txtMesas.getText()));
            abDao.RegistrarAmbiente(ab);
    ...
    private void btnActualizarSalaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarSalaActionPerformed
        ...
        if ("".equals(txtIdSala.getText())) {
            ...
            if (!"".equals(txtNombreSala.getText())) {
                ab.setNombre(txtNombreSala.getText());
                ab.setId(Integer.parseInt(txtIdSala.getText()));
                abDao.Modificar(ab);
    ...
    private void btnGuardarPlatoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarPlatoActionPerformed
        ...
        if (!"".equals(txtNombrePlato.getText()) || !"".equals(txtPrecioPlato.getText())) {
            car.setNombre(txtNombrePlato.getText());
            car.setPrecio(Double.parseDouble(txtPrecioPlato.getText()));
            car.setFecha(fechaFormato);
            if (carDao.Registrar(car)) {
    ...
    private void btnEditarPlatoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarPlatoActionPerformed
        ...
        if ("".equals(txtIdPlato.getText())) {
            ...
            if (!"".equals(txtNombrePlato.getText()) || !"".equals(txtPrecioPlato.getText())) {
                car.setNombre(txtNombrePlato.getText());
                car.setPrecio(Double.parseDouble(txtPrecioPlato.getText()));
                car.setId(Integer.parseInt(txtIdPlato.getText()));
    ...
    private void ListarPedidos() {
        ...
        for (int i = 0; i < Listar.size(); i++) {
            ...
            ob[1] = Listar.get(i).getAmbiente();
            ob[2] = Listar.get(i).getUsuario();
            ob[3] = Listar.get(i).getNum_box();
    ...
    private void ListarUsuarios() {
        List<Usuarios> Listar = lgDao.ListarUsuarios();
    ...
    private void ListarAmbiente() {
        List<Ambiente> Listar = abDao.Listar();
        modelo = (DefaultTableModel) tableSala.getModel();
        Object[] ob = new Object[3];
        for (int i = 0; i < Listar.size(); i++) {
            ob[0] = Listar.get(i).getId();
            ob[1] = Listar.get(i).getNombre();
            ob[2] = Listar.get(i).getBox();
            modelo.addRow(ob);
        }
    ...
    private void panelSalas() {
        ...
        for (int i = 0; i < Listar.size(); i++) {
            ...
            int cantidad = Listar.get(i).getBox();
            JButton boton = new JButton(Listar.get(i).getNombre(), new ImageIcon(getClass().getResource("/Iconos/salas.png")));
    ...
    private void panelMesas(int id_sala, int cant) {
        for (int i = 1; i <= cant; i++) {
            int num_mesa = i;
            //verificar estado
            JButton boton = new JButton("BOX N°: " + i, new ImageIcon(getClass().getResource("/Iconos/mesa.png")));
            boton.setHorizontalTextPosition(JButton.CENTER);
            boton.setVerticalTextPosition(JButton.BOTTOM);
    ...
    //carta
    private void ListarCarta(JTable tabla) {
        List<Carta> Listar = carDao.Listar(txtBuscarPlato.getText(), fechaFormato);
        ...
        for (int i = 0; i < Listar.size(); i++) {
            ...
            ob[3] = Listar.get(i).getStock();
            ob[4] = Listar.get(i).getTipo();
            ob[5] = Listar.get(i).getPresentacion();
            modelo.addRow(ob);
        }
        colorHeader(tabla);
    }
    ...
    private void RegistrarPedido() {
        int id_ambiente = Integer.parseInt(txtTempIdSala.getText());
        int num_box = Integer.parseInt(txtTempNumMesa.getText());
        double monto = Totalpagar;
        ped.setId_ambiente(id_ambiente);
        ped.setNum_box(num_box);
        ped.setTotal(monto);
    ...
    public void verPedido(int id_pedido) {
        ...
        txtSalaFinalizar.setText("" + ped.getAmbiente());
        txtNumMesaFinalizar.setText("" + ped.getNum_box());
